...
Hp12c_storage.prototype.save = function() {
	localStorage.setItem('TOUCH12I', H.storage.save_memory2(H.machine));
};

Hp12c_storage.prototype.load = function() {
	var sserial = "" + localStorage.getItem('TOUCH12I');
...
{
    document.location = "touch12i:tclick:1";
    dontclick = 1;
};
...
Hp12c_dispatcher.prototype.dispatch = function (k)
{
    ...
    if (comma_status != H.machine.comma) {
        ...
        if (comma_status) {
            document.location = "touch12i:commaon:1";
        } else {
            document.location = "touch12i:commaoff:0";        
        }
        return;
    }
    if (dontclick) {
        ...
        document.location = "touch12i:click:1";
    }
}
